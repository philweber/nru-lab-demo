...
wget https://github.com/newrelic/fluent-bit-package/releases/download/1.9.3/fluent-bit_1.9.3_ubuntu-focal_amd64.deb
sudo apt install ./fluent-bit_1.9.3_ubuntu-focal_amd64.deb -y
...
# Clean up
rm fluent-bit_1.9.3_ubuntu-focal_amd64.deb
